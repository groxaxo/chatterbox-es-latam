...
def export_model_to_onnx(
    ...
    if ckpt_dir:
        ...
        print(f"Loading local model from {ckpt_dir}...")
        chatterbox_model = ChatterboxTTS.from_local(ckpt_dir=ckpt_dir, device=device)
    elif multilingual:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default=None, help="Path to merged model (optional)")
